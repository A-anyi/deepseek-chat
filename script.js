...
function updateInputPlaceholder() {
    if (editingMessageIndex !== null) {
        ...
        messageInput.placeholder = 'R1 深度思考...（Shift+Enter 换行）';
    } else {
...
function renderTokenStats() {
    ...
    // 如果 total 为 0 但 messages 不为空，用估算值
